...
def overview_data(data):
    ...
    st.subheader('As informações a seguir correspondem aos dados crus, ou seja, sem limpeza prévia. Dados coletados do site: https://www.kaggle.com/datasets/harlfoxem/housesalesprediction.')
