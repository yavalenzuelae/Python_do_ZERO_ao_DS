...
def overview_data(data):
    ...
    st.subheader('As informações a seguir correspondem aos sem limpeza prévia coletados do site: https://www.kaggle.com/datasets/harlfoxem/housesalesprediction.')
